...
{
    // Autocadastro de Médico. Página própria (não a Register padrão do
    ...
    public class RegisterMedicoModel : PageModel
    {
        ...
        private async Task CarregarListasAsync()
        {
            ...
            // Bônus do enunciado: mostrar somente os planos de Médico nessa
            // página. Ajuste o filtro abaixo conforme o nome exato dos
            // planos no seu banco (ex.: "Médico Total", "Médico Parcial").
